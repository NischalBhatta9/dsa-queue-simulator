...
public:
  ...
  Road(float x, float y, float width, float height) {
    shape.setSize(sf::Vector2f(width, height));
    shape.setPosition(x, y);
    shape.setFillColor(sf::Color(40, 40, 45));
  }
};
...
int main() {
  ...
  Lane lane1(100, 260, 250, 20, sf::Color(80, 80, 85), sf::Color(255, 87, 51),
             &trafficLight2, true, true); // left priority lane - Orange cars
  Lane lane2(100, 290, 250, 40, sf::Color(80, 80, 85), sf::Color(231, 76, 60),
             &trafficLight2); // Red cars
  Lane lane3(100, 340, 250, 20, sf::Color(80, 80, 85), sf::Color(192, 57, 43),
             &trafficLight2); // Dark red cars
  Lane lane7(470, 260, 250, 20, sf::Color(80, 80, 85), sf::Color(52, 152, 219),
             &trafficLight1); // right - Blue cars
  Lane lane8(470, 290, 250, 40, sf::Color(80, 80, 85), sf::Color(41, 128, 185),
             &trafficLight1); // Dark blue cars
  Lane lane9(470, 340, 250, 20, sf::Color(80, 80, 85), sf::Color(30, 144, 255),
             &trafficLight1, true); // Dodger blue cars
  Lane lane4(360, 000, 20, 250, sf::Color(80, 80, 85), sf::Color(46, 204, 113),
             &trafficLight3); // top - Green cars
  Lane lane5(390, 000, 40, 250, sf::Color(80, 80, 85), sf::Color(39, 174, 96),
             &trafficLight3); // Darker green cars
  Lane lane6(440, 000, 20, 250, sf::Color(80, 80, 85), sf::Color(26, 188, 156),
             &trafficLight3, true); // Turquoise cars
  Lane lane10(440, 370, 20, 250, sf::Color(80, 80, 85), sf::Color(155, 89, 182),
              &trafficLight4, true, true); // bottom priority lane - Purple cars
  Lane lane11(390, 370, 40, 250, sf::Color(80, 80, 85), sf::Color(142, 68, 173),
              &trafficLight4); // Dark purple cars
  Lane lane12(360, 370, 20, 250, sf::Color(80, 80, 85), sf::Color(241, 196, 15),
              &trafficLight4, true); // Yellow cars
